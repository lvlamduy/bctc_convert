...
def test_production_policy_pins_1713_and_all_27_required_owners(project_root: Path) -> None:
    ...
    assert policy.schema_item_count == TM_CONSOLIDATED_SCHEMA_COUNT == 1_713
...
def test_actual_page45_production_result_exports_exact_value_dash_blank_surface(
    ...
    residual = _MappingResult(
        ...
        status_reconciled_schema_count=1_700,
        mapped_schema_count=0,
        ambiguous_schema_count=0,
        unresolved_schema_count=0,
        not_observed_schema_count=1_700,
        not_applicable_schema_count=0,
    ...
    assert artifact.schema_item_count == 1_713

...
from test_gemini_json_other_long_term_investments_family_v1 import (
    _base_page,
    _compiled,
    _json,
)
...
def _fixture(tmp_path):
    ...
    compiled = _compiled()
    evidence = query_selected_other_long_term_investments_family_regions_v1(
        database,
...
def test_indexed_query_flat_sweep_and_sqlite_candidate_replay(tmp_path) -> None:
    ...
    sweep = build_gemini_json_flat_family_sweep_v1(
        ...
        topology_spec=_json("tm-other-long-term-investments-topology-v1.json"),
        evaluation_spec=_json("tm-other-long-term-investments-evaluation-v1.json"),
        schema_binding_spec=_json("tm-other-long-term-investments-schema-binding-v1.json"),
        trials=trials,

...
from bctc_ai.corpus.wave1_role_b_full_reader_v3 import (  # noqa: E402
    _canonical_bytes,
...
def main() -> int:
    ...
    if arguments.command == "control":
        ...
        verification = verify_authenticated_full_reader(
            PROJECT_ROOT, model_cache=arguments.model_cache
        )
        result = verification["aggregate"]
        summary = {
            "status": result["status"],
            ...
            **result["accounting"],
            "authenticated_published_aggregate_present": verification[
        ...
        summary = {
            ...
            "artifact_size_bytes": len(_canonical_bytes(result)),
            **result["accounting"],
            "authenticated_published_aggregate_present": True,
        }

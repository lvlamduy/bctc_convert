...
FULL_RUNTIME_ROOT = (
    PROJECT_ROOT / "output/development/bank-corpus-wave-1-role-b-page-reader-v1/full-v1/runtime"
)
...
def _load_task(path: Path) -> dict[str, Any]:
    ...
    if (
        task["format_version"] != "BANK_CORPUS_WAVE_1_PPOCRV6_FULL_WORKER_TASK_V1"
    ...
    try:
        with PPOCRV6PageSession(
            ...
            for request in task["requests"]:
                ...
                _validate_execution_lease(task["execution_lease"])
                response = {
                    "format_version": "BANK_CORPUS_WAVE_1_PPOCRV6_FULL_WORKER_RESPONSE_V1",

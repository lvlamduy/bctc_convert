...
- **VPB quantitative-TM mechanism:** local-region policy SHA-256 `be1b87ca…689c`, implementation SHA-256 `d8cb5b7a…3142`; TM-context policy SHA-256 `9c7989fa…98f`, projection SHA-256 `f2874a66…ef6f`. The registered source-only full-document artifact policy is pinned to those exact region bytes and is ready for publication from the clean producer commit. No canonical TM observation or mapped Excel is claimed by this source-inventory milestone.

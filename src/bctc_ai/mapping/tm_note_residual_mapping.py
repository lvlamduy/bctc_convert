...
TM_RESIDUAL_SCHEMA_TOTAL = 1_613
TM_RESIDUAL_SCOPE_SCHEMA_COUNT = 85
TM_RESIDUAL_MAPPED_SCHEMA_COUNT = 2
TM_RESIDUAL_NOT_OBSERVED_SCHEMA_COUNT = 83
TM_RESIDUAL_UNASSESSED_SCHEMA_COUNT = 1_528
...
TM_FINAL_MAPPED_SCHEMA_COUNT = 799
TM_FINAL_UNRESOLVED_SCHEMA_COUNT = 85
TM_FINAL_NOT_OBSERVED_SCHEMA_COUNT = 706
...
def load_tm_residual_mapping_policy(path: Path) -> TMResidualMappingPolicy:
    ...
    if (
        ...
        or policy.mapping_authority_scope != "MBB_CONSOLIDATED_Q1_2026_EXACT_RESIDUAL_85_ONLY"
...
def reconcile_tm_residual_items(
    ...
    *,
    ...
    result = TMResidualMappingResult(
        ...
        status="EXACT_RESIDUAL_85_RECONCILED_WITH_TWO_STRUCTURAL_HEADINGS",

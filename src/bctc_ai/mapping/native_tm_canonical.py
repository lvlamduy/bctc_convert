...
def _validate_policy_payload(payload: Any) -> dict[str, Any]:
    ...
    _require_exact(
        ...
        },
        {
            ...
            "item_count": UNIVERSAL_TM_SCHEMA_ITEM_COUNT,
    ...
    _validate_identity(
        schema["schema_registry"],
        {
            ...
            "sha256": "5e033b41701394bc7e7899662a96c77f16025ebfd4ad19b069bbf9e97273cd6d",
        },
        "schema registry",
    )
    _validate_identity(
        schema["schema_graph"],
        {
            ...
            "sha256": "3fea408082263c171e98d1edc9b61608261b8a66b83706a5d7d029f9b0655403",
        },
        "schema graph",
    )
    _validate_identity(
    ...
    _validate_identity(
        schema["coverage_registry"],
        {
            ...
            "sha256": "e90a49977543dd51d9be5e003eda8d963938701b54da2e9396a7081134566f2f",
        },
    ...
    _require_exact(
        ...
        {
            "tm_projection_sha256": "2cf36bfdf56ae18bb36fe37cf34881eb7e48731d67fd44d66c1611ded2b7ced6",
            "tm_context_projection_sha256": "f3d13642c4c7c26fc3cd9110e8d7d4e4eece77e10f6a953006734363af0371f0",
        },
    ...
    _require_exact(
        ...
        },
        {
            ...
            "tm_projection_record_count": 7,
            "tm_projection_sha256": "c65829ac0cfbf86b024fa3cf162bf05cf0d8c982d8b710ea1178995dc98117d3",
        },
        ...
        [
            {
                ...
                "sha256": "63d88438ab2c160862350564d89e21183f676a2a74120c1ccdb55560c900576d",
            }
        ],
    ...
    _require_exact(
        ...
        {
            "statement_type": _STATEMENT_TYPE,
            "schema_item_count": UNIVERSAL_TM_SCHEMA_ITEM_COUNT,
...
def _validate_replay_policy_minimum(payload: Any) -> dict[str, Any]:
    ...
    if (
        ...
        or schema.get("item_count") != UNIVERSAL_TM_SCHEMA_ITEM_COUNT
        ...
        or coverage.get("schema_item_count") != UNIVERSAL_TM_SCHEMA_ITEM_COUNT

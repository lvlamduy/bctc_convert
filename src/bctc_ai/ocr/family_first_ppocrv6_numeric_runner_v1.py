...
_KERNEL_PATH = Path("src/bctc_ai/ocr/ppocrv6_numeric_reference_blind_kernel_v1.py")
_IMPLEMENTATION_PATH = Path("src/bctc_ai/ocr/family_first_ppocrv6_numeric_runner_v1.py")
_ORCHESTRATOR_PATH = Path("scripts/experiments/run_family_first_ppocrv6_numeric_v1.py")
_INDEX_PATH = Path("src/bctc_ai/evaluation/family_first_ppocrv6_numeric_index_v1.py")
...
def _git_binding(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "dirty": False,
        "implementation_refs": [
            runtime_v3._tracked_ref(root, path, f"numeric trust file {path}") for path in paths
        ],

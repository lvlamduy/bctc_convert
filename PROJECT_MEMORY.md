...
- Latest full test run after adding the E-0013 bootstrap audit: 145 passed and 2 immutable-historical replays skipped; Ruff lint and the changed-file formatter gate passed. E-0006 and E-0009 source/config identities remain verified, but exact replay is skipped when their historical algorithm byte hashes are not the current implementation. E-0010 through E-0013 provide current hash-locked integration regressions.
...
- Use only the clean E-0013 eligible-page contracts plus their off-balance exclusion boundaries for 200-DPI Role B/Role C processing; do not treat the located pages as row-level truth.

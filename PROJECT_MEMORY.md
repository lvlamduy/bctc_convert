...
- Latest full test run after E-0012 bootstrap-audit integration: 127 passed and 2 immutable-historical replays skipped; Ruff lint passed on the full source/test/script tree. E-0006 and E-0009 source/config identities remain verified, but exact replay is skipped when their historical algorithm byte hashes are not the current implementation. E-0010, E-0011, and E-0012 provide current hash-locked integration regressions.

...
- Latest full test run: 98 passed and 1 immutable-historical replay skipped in 36.55 seconds; Ruff lint passed. The E-0006 source/config identity remains verified, but replay is skipped because its exact historical algorithm hashes are not the current implementation. E-0010 provides a current hash-locked integration regression.

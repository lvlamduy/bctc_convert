...
18. Before a multi-page PP-OCRv6 run or resume, follow `BATCH_OCR_RUNBOOK.md`. Resume must use the same inference commit, manifest, page set, role, thread count, config, runtime, and model hashes; otherwise start a new output/experiment identity.

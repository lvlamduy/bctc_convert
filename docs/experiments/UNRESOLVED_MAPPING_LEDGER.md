...
remain `UNRESOLVED_EVIDENCE_GATES`. Mỗi hàng dưới đây là **một PDF**, không
gộp nhiều kỳ hoặc nhiều loại báo cáo. Locator, raw labels và reason codes được
dẫn xuất từ:
`output/calibration/family-first-accounting-evidence-sweeps-v1/trading-securities.json`.

### ACB — 15 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-001 | Năm 2025 — hợp nhất — kiểm toán | p47–48 | Owner `Chi tiết chứng khoán kinh doanh`.<br>`Chứng khoán nợ do các TCTD khác trong nước phát hành (i) (ii)` — thiếu cột body 2<br>`Chứng khoán nợ do các TCKT trong nước phát hành (i) (ii)` — thiếu cột body 2<br>`Chưa niếm yết` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p47–48; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-002 | Năm 2025 — công ty mẹ/riêng lẻ — kiểm toán | p41 | Owner `Chi tiết chứng khoán kinh doanh`.<br>`Chứng khoán nợ do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chưa niêm yết` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-003 | H1/2025 — hợp nhất — soát xét | p46–47 | Owner `Chi tiết chứng khoán kinh doanh`.<br>`Chứng khoán nợ do các TCTD trong nước phát hành (i)` — thiếu cột body 2<br>`Chứng khoán nợ do các TCKT trong nước phát hành (i)` — thiếu cột body 2<br>`Chưa niếm yết` — thiếu cột body 2<br>`Dự phòng giảm giá` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p46–47; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-005 | Q1/2025 — hợp nhất — không kiểm toán | p15 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`Chứng khoán do các tổ chức kinh tế ("TCKT") trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-006 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p15 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD trong nước phát hành` — thiếu cột body 1, 2<br>`Chứng khoán vốn do các tổ chức kinh tế trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-007 | Q2/2025 — hợp nhất — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chúng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán do các tổ chức kinh tế (?TCKT?) trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-008 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD trong nước phát hành` — thiếu cột body 1, 2<br>`Chứng khoán vốn do các tổ chức kinh tế trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-009 | Q3/2025 — hợp nhất — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán do các tổ chức kinh tế ("TCKT") trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-010 | Q3/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-011 | Q4/2025 — hợp nhất — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán do các tổ chức kinh tê ("TCKT") trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-012 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán do các TCTD trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán vốn do các tổ chức kinh tế trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-097 | H1/2026 — hợp nhất — soát xét | p45–46 | Owner `Chi tiết chứng khoán kinh doanh`.<br>`Đã niếm yết` — thiếu cột body 2<br>`Chưa niếm yết` — thiếu cột body 2<br>`Dự phòng giảm giá` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p45–46; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-098 | H1/2026 — công ty mẹ/riêng lẻ — soát xét | p41 | Owner `Chi tiết chứng khoán kinh doanh`.<br>`) Chứng khoán nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-100 | Q1/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán vốn do các tổ chức kinh tế trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-102 | Q2/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p16 | Owner `2. CHỨNG KHOÁN KINH DOANH:`.<br>`Chứng khoán vốn do các tổ chức kinh tế trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |

### MBB — 12 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-013 | Năm 2025 — hợp nhất — kiểm toán | p49–50 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>Subtotal `Chứng khoán nợ`<br>Subtotal `Chứng khoán vốn` | Vùng kéo dài p49–50; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Subtotal nguồn `Chứng khoán nợ`, `Chứng khoán vốn` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-015 | H1/2025 — hợp nhất — soát xét | p48–49 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>Subtotal `Chứng khoán nợ`<br>Subtotal `Chứng khoán vốn` | Vùng kéo dài p48–49; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Subtotal nguồn `Chứng khoán nợ`, `Chứng khoán vốn` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-016 | H1/2025 — công ty mẹ/riêng lẻ — soát xét | p38 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>Child nhìn thấy: `Chứng khoán do các TCTD khác trong nước phát hành (i)` | Body đang tạo 1 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. |
| TS-017 | Q1/2025 — hợp nhất — không kiểm toán | p30 | Owner `4. Chứng khoán kinh doanh`.<br>`Đã niêm yết` — thiếu cột body 1<br>`Chưa niêm yết` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-018 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `4. Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-020 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `4. Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-022 | Q3/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-024 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-103 | H1/2026 — hợp nhất — soát xét | p51–52 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>`Chứng chỉ tiền gửi do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p51–52; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-104 | H1/2026 — công ty mẹ/riêng lẻ — soát xét | p41 | Owner `8. CHỨNG KHOẢN KINH DOANH`.<br>`Chứng chỉ tiền gửi do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-106 | Q1/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `4. Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-108 | Q2/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p27 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do Chính phủ phát hành` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |

### VPB — 9 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-025 | Năm 2025 — hợp nhất — kiểm toán | p43 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán nợ do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán vốn do các TCTD khác trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-027 | H1/2025 — hợp nhất — soát xét | p45 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chỉnh phủ, chính quyền địa phương` — thiếu cột body 2<br>`(55.750) (57.176) Dự phòng giảm giá` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-028 | H1/2025 — công ty mẹ/riêng lẻ — soát xét | p37 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 3<br>`Đã niêm yết` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-029 | Q1/2025 — hợp nhất — không kiểm toán | p40 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 2<br>`(137.392) (69.750) Dự phòng cụ thể` — thiếu cột body 1, 2<br>`(55.490) Dự phòng chung` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-030 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p30–31 | Owner `Chứng khoán kinh doanh`.<br>Subtotal `Chứng khoán nợ` | Vùng kéo dài p30–31; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Body đang tạo 1 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. Subtotal nguồn `Chứng khoán nợ` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-031 | Q2/2025 — hợp nhất — không kiểm toán | p40 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 2<br>`(55.750) (57.176) Dự phòng giám giá` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-032 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p31–32 | Owner `Chứng khoán kinh doanh`.<br>Subtotal `Chứng khoán nợ` | Vùng kéo dài p31–32; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Body đang tạo 1 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. Subtotal nguồn `Chứng khoán nợ` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-033 | Q3/2025 — hợp nhất — không kiểm toán | p40 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán vốn do các TCTD khác phát hành` — thiếu cột body 2<br>`(143.194) (69.750) Dự phòng chung` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-035 | Q4/2025 — hợp nhất — không kiểm toán | p40 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán vốn do các TCTD khác phát hành` — thiếu cột body 2<br>`(172.266) (69.750) Dự phòng chung` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |

### HDB — 16 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-037 | Năm 2025 — hợp nhất — kiểm toán | p34–35 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Chưa niêm yết` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Các nhãn kỳ tương đối (`Số cuối kỳ`/`Số đầu kỳ`) tạo record trùng hoặc sai closed shape; period-axis validator từ chối trước mapping. |
| TS-038 | Năm 2025 — công ty mẹ/riêng lẻ — kiểm toán | p33–34 | Owner `8. chứng khoán kinh doanh`.<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chưa niêm yết` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Các nhãn kỳ tương đối (`Số cuối kỳ`/`Số đầu kỳ`) tạo record trùng hoặc sai closed shape; period-axis validator từ chối trước mapping. |
| TS-039 | H1/2025 — hợp nhất — soát xét | p32–33 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Các nhãn kỳ tương đối (`Số cuối kỳ`/`Số đầu kỳ`) tạo record trùng hoặc sai closed shape; period-axis validator từ chối trước mapping. |
| TS-040 | H1/2025 — công ty mẹ/riêng lẻ — soát xét | p31–32 | Owner `8. CHỨNG KHOÁN KINH DOANH`.<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Các nhãn kỳ tương đối (`Số cuối kỳ`/`Số đầu kỳ`) tạo record trùng hoặc sai closed shape; period-axis validator từ chối trước mapping. |
| TS-041 | Q1/2025 — hợp nhất — không kiểm toán | p29 | Owner `1. Chứng khoán kinh doanh`.<br>`Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Chúng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`- Dự phòng cụ thể` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-042 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p28 | Owner `Chứng khoán kinh doanh`.<br>`- Chúng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`- Dự phòng cụ thể` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-043 | Q2/2025 — hợp nhất — không kiểm toán | p34 | Owner `1. Chứng khoán kinh doanh`.<br>`Chúng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`Dự phòng cụ thể` — thiếu cột body 1, 2<br>`%Chưa niêm yết` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-044 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p31 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`- Dự phòng cụ thể` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-045 | Q3/2025 — hợp nhất — không kiểm toán | p26 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`- Dự phòng cụ thể` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-046 | Q3/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p23 | Owner `1. Chứng khoán kinh doanh`.<br>`Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1, 2<br>`- Chứng khoản do các TCKT trong nước phát hành` — thiếu cột body 1, 2<br>`Dự phòng chung` — thiếu cột body 1, 2<br>`- Dự phòng cụ thể` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-047 | Q4/2025 — hợp nhất — không kiểm toán | p23 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ` — thiếu cột body 1<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Chứng khoán Nợ - Đã niêm yết` — thiếu cột body 1<br>`Chưa niêm yết` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-048 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p21–22 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chưa niêm yết` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p21–22; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-115 | Q1/2026 — hợp nhất — không kiểm toán | p23 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ` — thiếu cột body 1, 2<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1, 3<br>`Chứng khoán Nợ - Đã niêm yết` — thiếu cột body 1, 2<br>`- Chưa niêm yết` — thiếu cột body 1, 3<br>`Giá trị thuần` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-116 | Q1/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p22 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ` — thiếu cột body 1, 2<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1, 3<br>`Chứng khoán Nợ - Đã niêm yết` — thiếu cột body 1, 2<br>`Chưa niêm yết` — thiếu cột body 1, 3<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-117 | Q2/2026 — hợp nhất — không kiểm toán | p24–25 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán Nợ do các TCKT khác trong nước phát hành` — thiếu cột body 2<br>`Chứng khoán Vốn do các TCTD khác phát hành` — thiếu cột body 2<br>`Chứng khoán Vốn do các TCKT trong nước phát hành` — thiếu cột body 2<br>`Dự phòng chung` — thiếu cột body 2<br>`(56.962) Dự phòng cụ thể` — thiếu cột body 2<br>`Chứng khoán Nợ - Đã niêm yết` — thiếu cột body 1<br>`- Chưa niêm yết` — thiếu cột body 1, 3<br>`Chứng khoán Vốn - Đã niêm yết` — thiếu cột body 1, 3<br>`- Chưa niêm yết` — thiếu cột body 1, 3<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p24–25; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Body đang tạo 3 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. |
| TS-118 | Q2/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p22 | Owner `Chứng khoán kinh doanh`.<br>`Chứng khoán Chính phủ` — thiếu cột body 1, 2<br>`Chứng khoán Nợ do các TCTD khác trong nước phát hành` — thiếu cột body 1, 3<br>`Chứng khoán Nợ - Đã niêm yết` — thiếu cột body 1, 2<br>`- Chưa niêm yết` — thiếu cột body 1, 3<br>`Giá trị thuần` — thiếu cột body 1, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |

### VCB — 3 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-049 | Năm 2025 — hợp nhất — kiểm toán | p37–38 | Owner `7. Chứng khoán kinh doanh`.<br>`Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p37–38; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-059 | Q4/2025 — hợp nhất — không kiểm toán | p29–30 | Owner `7. Chứng khoán kinh doanh`.<br>`Trái phiếu do các TCKT trong nước phát hành` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p29–30; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-060 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p31 | Owner `7. Chứng khoán kinh doanh`.<br>Child nhìn thấy: `Chứng khoán nợ`; `Chứng khoán nợ Chưa niêm yết` | Header kỳ hoặc đơn vị chưa bind tới mọi cột body. |

### CTG — 12 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-061 | Năm 2025 — hợp nhất — kiểm toán | p41–42 | Owner `CHỨNG KHOẢN KINH DOANH`.<br>`Dự phòng giảm giá` — thiếu cột body 1 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p41–42; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-063 | H1/2025 — hợp nhất — soát xét | p45 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>Subtotal `Chứng khoán nợ` | Subtotal nguồn `Chứng khoán nợ` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-065 | Q1/2025 — hợp nhất — không kiểm toán | p39 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>Subtotal `Chứng khoán Nợ` | Subtotal nguồn `Chứng khoán Nợ` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-066 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p35 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Body đang tạo 1 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. |
| TS-068 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p34 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-070 | Q3/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p34 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-071 | Q4/2025 — hợp nhất — không kiểm toán | p37 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>Subtotal `Chứng khoán Vốn` | Subtotal nguồn `Chứng khoán Vốn` không bằng tổng tập child hiện bind. Issuer view và listed/unlisted view có thể là hai cách trình bày cùng population nên không được cộng union để ép đóng. |
| TS-072 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p35 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-125 | H1/2026 — hợp nhất — soát xét | p34–35 | Owner `5. CHỨNG KHOÁN KINH DOANH`.<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p34–35; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. |
| TS-126 | H1/2026 — công ty mẹ/riêng lẻ — soát xét | p29 | Owner `5. CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ` — thiếu cột body 1, 3<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-128 | Q1/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p34 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-130 | Q2/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p33 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Body đang tạo 1 cột nhưng trục kỳ/đơn vị khai báo không cùng denominator; kỳ và đơn vị chưa phủ từng cột. |

### BID — 11 filing còn mở

| ID | Filing | Trang | Owner/khoản mục nguồn cần xử lý | Lý do chưa map |
| --- | --- | ---: | --- | --- |
| TS-073 | Năm 2025 — hợp nhất — kiểm toán | p40–41 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 3<br>`Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1, 3<br>`Dự phòng giảm giá` — thiếu cột body 1, 3<br>`(24.980) (37.199) Dự phòng chung` — thiếu cột body 1, 2, 3, 4 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p40–41; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-074 | Năm 2025 — công ty mẹ/riêng lẻ — kiểm toán | p33–34 | Owner `CHỨNG KHOÁN KINH DOANH`.<br>`Chứng khoán Nợ Chưa niêm yết` — thiếu cột body 1, 2, 4 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Vùng kéo dài p33–34; header kỳ/đơn vị ở một trang chưa có edge xác thực sang trang tiếp theo. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-075 | H1/2025 — hợp nhất — soát xét | p36 | Owner `5. CHỨNG KHOÁN KINH DOANH`.<br>`(36.659) (39.280) Dự phòng giảm giá` — thiếu cột body 1, 2 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. |
| TS-077 | Q1/2025 — hợp nhất — không kiểm toán | p20 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán nước ngoài` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-078 | Q1/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 3<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-080 | Q2/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-081 | Q3/2025 — hợp nhất — không kiểm toán | p20 | Owner `1. CHỨNG KHOÁN KINH DOANH`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán do các TCKT trong nước phát hành` — thiếu cột body 1<br>`- Chứng khoán nước ngoài` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-082 | Q3/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-084 | Q4/2025 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán do các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-132 | Q1/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`- Chứng khoán Chính phủ, chính quyền địa phương` — thiếu cột body 1, 3<br>`- Chứng khoán do, các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
| TS-134 | Q2/2026 — công ty mẹ/riêng lẻ — không kiểm toán | p19 | Owner `1. Chứng khoán kinh doanh`.<br>`Chứng khoán do.các TCTD khác trong nước phát hành` — thiếu cột body 1<br>`Giá trị thuần` — thiếu cột body 1, 2, 3 | Ít nhất một hàng không bind đủ mọi cột body; không điền ô thiếu hoặc coi ô trống là 0 khi chưa có crop dấu gạch độc lập. Header local/ô số bị merge hoặc thiếu nên geometry còn nhiều cách dựng cột; chưa có một trục body–header duy nhất. |
